...
let config = {
    appid: "0f1422e845464b68bd7a53260a9fb7e0",
    token: "007eJxTYNB8s1box6MN99XXqdZe+nTPXHB6VMSaC8LaTrpTM/+yyq9WYDBIMzQxMkq1MDE1MTNJMrNISjFPNDU2MjNItExLMk81OHnZMKUhkJEh62oiIyMDBIL4rAwl+dmpeQwMAIxeIBo=",
    uid: null,
    channel: "token",
}
...
let joinStreams = async () => {
    ...
    let player = `<div class="video-containers" id="video-wrapper-${config.uid}">
                        <p class="user-uid"><img class="volume-icon" id="volume-${config.uid}" src="./assets/volume-on.svg" /> 
...
let handleUserJoined = async (user, mediaType) => {
    ...
    if (mediaType === 'video') {
        ...
        player = `<div class="video-containers" id="video-wrapper-${user.uid}">
                <p class="user-uid"><img class="volume-icon" id="volume-${user.uid}" src="./assets/volume-on.svg" /> 
